...
QList<BitmarkUnits::Unit> BitmarkUnits::availableUnits()
{
    ...
    unitlist.append(ZMK);
    unitlist.append(mZMK);
    unitlist.append(uZMK);
    return unitlist;
}
...
QString BitmarkUnits::name(int unit)
{
    switch(unit)
    {
    case ZMK: return QString("ZMK");
    case mZMK: return QString("uZMK");
    case uZMK: return QString::fromUtf8("uZMK");
...
QString BitmarkUnits::description(int unit)
{
    switch(unit)
    {
    case ZMK: return QString("Zmarks");
    case mZMK: return QString("mZmarks (1 / 1,000)");
    case uZMK: return QString("uZmarks (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
qint64 BitmarkUnits::factor(int unit)
{
    switch(unit)
    {
    case ZMK:  return 100000000;
    case mZMK: return 100000;
    case uZMK: return 100;
...
qint64 BitmarkUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case ZMK:  return Q_INT64_C(21000000);
    case mZMK: return Q_INT64_C(21000000000);
    case uZMK: return Q_INT64_C(21000000000000);
    default:   return 0;
    }
}
...
int BitmarkUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case ZMK: return 8; // 21,000,000 (# digits, without commas)
    case mZMK: return 11; // 21,000,000,000
    case uZMK: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
