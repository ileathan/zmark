    ...
    model(0)
{
    ...
    // normal zmark address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying zmark address(es)
    ui->payTo_is->setFont(GUIUtil::zmarkAddressFont());
}
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("ZMK")
    updateDisplayUnit();
}
