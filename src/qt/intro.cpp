...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/zmark"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Zmark"),
     ...
     * override -datadir in the zmark.conf file in the default data directory
     * (to be consistent with zmarkd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
