    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zmark Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
#ifndef Q_OS_MAC
        QApplication::setWindowIcon(QIcon(":icons/zmark"));
        setWindowIcon(QIcon(":icons/zmark"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/zmark"));
#endif
    }
    else
    {
...
#ifndef Q_OS_MAC
        QApplication::setWindowIcon(QIcon(":icons/zmark_testnet"));
        setWindowIcon(QIcon(":icons/zmark_testnet"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/zmark_testnet"));
#endif
    }
...
void BitmarkGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zmark address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zmark: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/zmark"), tr("&About Zmark Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/zmark_testnet"), tr("&About Zmark Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zmark"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zmark"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/zmark"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/zmark_testnet"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zmark addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zmark addresses"));
    ...
    openAction->setStatusTip(tr("Open a zmark: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Zmark Core help message to get a list with possible Bitmark command-line options"));
...
void BitmarkGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Zmark client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Zmark client") + " " + tr("[testnet]"));
...
void BitmarkGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zmark network", "", count));
}
...
{
    QString strTitle = tr("Zmark"); // default title
