...
{
    BOOST_CHECK(TestSplitHost("www.zmark.org", "www.zmark.org", -1));
    BOOST_CHECK(TestSplitHost("[www.zmark.org]", "www.zmark.org", -1));
    BOOST_CHECK(TestSplitHost("www.zmark.org:80", "www.zmark.org", 80));
    BOOST_CHECK(TestSplitHost("[www.zmark.org]:80", "www.zmark.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8388", "127.0.0.1", 8388));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8388", "127.0.0.1", 8388));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8388", "::ffff:127.0.0.1", 8388));
    BOOST_CHECK(TestSplitHost("[::]:8388", "::", 8388));
    BOOST_CHECK(TestSplitHost("::8388", "::8388", -1));
    BOOST_CHECK(TestSplitHost(":8388", "", 8388));
    BOOST_CHECK(TestSplitHost("[]:8388", "", 8388));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8388", "127.0.0.1:8388"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8388", "[::]:8388"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
