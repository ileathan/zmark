The following is a list of assets used in the zmark source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original zmark logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/zmark.icns, src/qt/res/src/zmark.svg,
	src/qt/res/src/zmark.ico, src/qt/res/src/zmark.png,
	src/qt/res/src/zmark_testnet.png, docs/zmark_logo_doxygen.png,
