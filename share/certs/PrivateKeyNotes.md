...
unlocked to sign the Zmark-Qt.app bundle.
...
allowing somebody to distribute a Zmark-Qt.app or zmark-qt-setup.exe with a valid
...
that the zmark-qt.exe file inside the installer had not been tampered with.
